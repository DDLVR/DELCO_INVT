...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'nombre_base_de_datos'),
        'USER': os.environ.get('DB_USER', 'usuario_base_de_datos'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'REMOVED_DB_PASSWORD'),
